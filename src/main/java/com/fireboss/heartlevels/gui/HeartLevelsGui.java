...
public class HeartLevelsGui extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRendererObj, I18n.format("gui.statsheader", new Object[0]), sr.getScaledWidth()/2, sr.getScaledHeight()/2-32, 0xE0E0E0);
		drawCenteredString(fontRendererObj, I18n.format("gui.currenthearts", new Object[]{mc.thePlayer.getHealth() / 2.0}),
				sr.getScaledWidth()/2, sr.getScaledHeight()/2-22, 0xE0E0E0);
		drawCenteredString(fontRendererObj, I18n.format("gui.maxhealth", new Object[] {mc.thePlayer.getMaxHealth() / 2.0}),
				sr.getScaledWidth()/2, sr.getScaledHeight()/2-12, 0xE0E0E0);
		drawCenteredString(fontRendererObj, I18n.format("gui.healthrpg", new Object[] {stats.count}), sr.getScaledWidth()/2, sr.getScaledHeight()/2-2, 0xE0E0E0);
		int extraHearts = 0;
		...
		drawCenteredString(fontRendererObj, I18n.format("gui.heartsench", new Object[] {extraHearts}), sr.getScaledWidth()/2, sr.getScaledHeight()/2+8,
				0xE0E0E0);
		...
		drawCenteredString(fontRendererObj, I18n.format("gui.heartconts", new Object[] {heartsFromContainers}),
		...
		drawCenteredString(fontRendererObj, I18n.format("gui.heartsother", new Object[] {mc.thePlayer.getMaxHealth() - 20}),
